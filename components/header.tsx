...
const Header = () => {
	return (
		<header
			id="welcome"
			className="bg-gradient-to-br from-green-100 to-lime-50"
		>
			<div className="flex justify-evenly h-screen items-center px-8">
